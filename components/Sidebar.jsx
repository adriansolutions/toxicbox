...
<>
  ...
  {openProfile && (
    ...
    <div className="fixed inset-0 z-[99999] bg-black/60 backdrop-blur-sm flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-3xl rounded-3xl overflow-hidden bg-white dark:bg-[#1e1f22] border border-white/10">
        ...
        <div className="px-8 pb-8">
          ...
          <div className="mt-5 p-5 rounded-2xl bg-black/5 dark:bg-white/5">
          ...
          <div className="mt-5 p-5 rounded-2xl bg-black/5 dark:bg-white/5 space-y-3">
