...
<div className="login-screen" id="loginScreen">
    <div className="login-box">
        <h2>Toxic Box</h2>
        <p>
            Enter your username and join the public chat room instantly.
        </p>
        ...
        <button className="start-btn" onClick={() => window.startChat?.()}>
            Enter Chat
        </button>
    </div>
</div>
...
<div className="app">
   <div className="header">
       <button onClick={() => window.toggleSidebar?.()} className="toggle-btn">☰</button>
        ...
        <div className="user-tag" id="userTag">
            Guest
        </div>
    </div>
